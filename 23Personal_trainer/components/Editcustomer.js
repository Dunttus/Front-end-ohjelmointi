...
const handleClickOpen = () => {
    ...
    setCustomer({firstname: props.customer.firstname, lastname: props.customer.lastname, email: props.customer.email,
        phone: props.customer.phone, streetaddress: props.customer.streetaddress, city: props.customer.city });
    setOpen(true);
}
...
const inputChanged = (event) => {
    ...
    return(
        <div>
            <Button startIcon={<SaveIcon />} button="small" color="primary" onClick={handleClickOpen}>
                Edit
            </Button>
